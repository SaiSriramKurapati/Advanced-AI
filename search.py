...
Original file is located at
    https://colab.research.google.com/drive/1UA0IbUTW4WYEdnl_mjrQdopk-X2-Mu-Y
"""

cd /content/drive/MyDrive/proj1-search-python3

! ls

! cat search.py

! cp /content/search.py .
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while open.isEmpty() != 1:
      ...
      for next_state in problem.getSuccessors(current_state):
          ...
          if next_state[0] not in closed_list:
